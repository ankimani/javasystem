 ...
 * @author albert
 */
public class labourtenant extends javax.swing.JFrame {
    ...
    public void update() {
        try {
            String sql = "SELECT `id` as 'S No', `tenantnumber`as 'Tenant NO', `tenantname`as 'Name', `telephone` as 'Telephone', `idnumber`as 'National Id', `dateofbirth` as 'DOB', `regdate`as 'Reg date', `location`as 'Location', `address`as 'Address', `photo` FROM `farmtenants` ";
    ...
    public void searching() {
        if (srch_combo.getSelectedItem().toString().equalsIgnoreCase("TENANT NUMBER")) {
            try {
                String sql = "SELECT `id` as 'S No', `tenantnumber`as 'Tenant NO', `tenantname`as 'Name', `telephone` as 'Telephone', `idnumber`as 'National Id', `dateofbirth` as 'DOB', `regdate`as 'Reg date', `location`as 'Location', `address`as 'Address', `photo` FROM `farmtenants` where tenantnumber='" + srch.getText() + "'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                table1.setModel(DbUtils.resultSetToTableModel(rs));
            } catch (Exception e) {
            ...
            try {
                String sql = "SELECT `id` as 'S No', `tenantnumber`as 'Tenant NO', `tenantname`as 'Name', `telephone` as 'Telephone', `idnumber`as 'National Id', `dateofbirth` as 'DOB', `regdate`as 'Reg date', `location`as 'Location', `address`as 'Address', `photo` FROM `farmtenants` where tenantname like'" + srch.getText() + "%'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                table1.setModel(DbUtils.resultSetToTableModel(rs));
            } catch (Exception e) {
            ...
            try {
                String sql = "SELECT `id` as 'S No', `tenantnumber`as 'Tenant NO', `tenantname`as 'Name', `telephone` as 'Telephone', `idnumber`as 'National Id', `dateofbirth` as 'DOB', `regdate`as 'Reg date', `location`as 'Location', `address`as 'Address', `photo` FROM `farmtenants` where idnumber ='" + srch.getText() + "'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                table1.setModel(DbUtils.resultSetToTableModel(rs));
            } catch (Exception e) {
            ...
            try {
                String sql = "SELECT `id` as 'S No', `tenantnumber`as 'Tenant NO', `tenantname`as 'Name', `telephone` as 'Telephone', `idnumber`as 'National Id', `dateofbirth` as 'DOB', `regdate`as 'Reg date', `location`as 'Location', `address`as 'Address', `photo` FROM `farmtenants` where telephone ='" + srch.getText() + "'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                table1.setModel(DbUtils.resultSetToTableModel(rs));
            } catch (Exception e) {
        ...
        if (tno.getText().isEmpty() || tno.getText() == null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    String sql = "INSERT INTO `farmtenants`(`tenantnumber`,`tenantname`, `telephone`, `idnumber`, `dateofbirth`, `regdate`, `location`, `address`, `photo`) VALUES (?,?,?,?,?,?,?,?,'" + image + "')";
                    pst = con.prepareStatement(sql);
    ...
    public void delete() {
        ...
        if (conf == 0) {
            try {
                String sql = "delete from farmtenants where id='" + id.getText() + "'";
                pst = con.prepareStatement(sql);
                pst.execute();
    ...
    public void edit() {
        ...
        image = image.replace("\\", "\\\\");
        try {
            String sql = "UPDATE `farmtenants` SET `tenantnumber`=?,`tenantname`=?,`telephone`=?,`idnumber`=?,`dateofbirth`=?,`regdate`=?,`location`=?,`address`=?,`photo`='" + image + "' WHERE id='" + id.getText() + "'";
            pst = con.prepareStatement(sql);
            pst.setString(1, tno.getText());
            pst.setString(2, tname.getText());
            pst.setString(3, telephone.getText());
    ...
    public void click() {
        ...
        try {
            ...
            String sql = "select * from farmtenants where id='" + clic + "'";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LABOUR TENANTS PORTAL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(labourtenant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new labourtenant().setVisible(true);
            }
        });
    }
