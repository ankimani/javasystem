...
public class configurations extends javax.swing.JFrame {
    ...
    public void count() {
        try {
            ...
            rs = pst.executeQuery();
            while (rs.next()) {
                count.setText(rs.getString("count(id)"));
            }
        } catch (Exception e) {
        }
    }
    ...
    public void add() {
        int cout = Integer.valueOf(count.getText());
        if (cout > 0) {
            JOptionPane.showMessageDialog(null, "Company Records Already Exist.", "Duplicate", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                String sql = "INSERT INTO `companies`(`companyname`,`description`, `city`, `address`, `telephone`, `email`, `website`, `pincode`, `vatnumber`) VALUES (?,?,?,?,?,?,?,?,?)";
                pst = con.prepareStatement(sql);
                ...
                pst.setString(8, pincode.getText());
                pst.setString(9, vat.getText());
                pst.execute();
    ...
    public void update() {
        try {
            String sql = "SELECT `id`, `companyname`, `description`, `city`, `address`, `telephone`, `email`, `website` FROM `companies`";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    public void clic() {
        try {
            ...
            String sql = "select * from companies where id='" + click + "'";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
                id.setText(rs.getString("id"));
                cname.setText(rs.getString("companyname"));
                ...
                vat.setText(rs.getString("vatnumber"));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public void edit() {
        if (id.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Select a Record to Edit", "Edit", JOptionPane.ERROR_MESSAGE);
        }
        
        else {
            try {
                String sql = "UPDATE `companies` SET `companyname`=?,`description`=?,`city`=?,`address`=?,`telephone`=?,`email`=?,`website`=?,`pincode`=?,`vatnumber`=? where id='" + id.getText() + "'";
                pst = con.prepareStatement(sql);
                pst.setString(1, cname.getText());
                pst.setString(2, desc.getText());
                pst.setString(3, city.getText());
    ...
    public void delete() {
        if (id.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Select a Record to Delete", "Delete", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                String sql = "delete from companies where id='" + id.getText() + "'";
                pst = con.prepareStatement(sql);
                pst.execute();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPANY SETTINGS");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(desc, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(vat, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE))
                        .addGap(30, 30, 30))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
